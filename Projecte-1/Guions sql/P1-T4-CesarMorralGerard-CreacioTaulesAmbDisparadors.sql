...
art_tipus CHAR(1) CONSTRAINT CK_ARTISTA_ART_TIPUS CHECK (art_tipus in('I','G'))
...
can_durada INTEGER CONSTRAINT NN_CANÇO_DURADA NOT NULL,
...
aut_idcanço INTEGER CONSTRAINT FK_AUTORIA_AUT_IDCANÇO REFERENCES CANÇO,
aut_artindid VARCHAR2(100) CONSTRAINT FK_AUTORIA_AUT_ARTINDID REFERENCES ART_IND
...
abc_idalbum INTEGER CONSTRAINT FK_ALBUM_CONT_IDALBUM REFERENCES ALBUM,
abc_idcanço INTEGER CONSTRAINT FK_ALBUM_CONT_IDCANÇO REFERENCES CANÇO,
...
llc_idllista INTEGER CONSTRAINT FK_LLISTA_LLC_IDLLISTA REFERENCES LLISTA,
llc_idcataleg INTEGER CONSTRAINT FK_LLISTA_LLC_IDCATALEG REFERENCES CATALEG,
...
rep_mt DATE,
rep_idcataleg INTEGER CONSTRAINT FK_REPRODUCCIO_IDCATALEG REFERENCES CATALEG,
